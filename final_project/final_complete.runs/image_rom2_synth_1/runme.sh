...
HD_PWD='C:/Users/user/Desktop/final_bb/final_complete.runs/image_rom2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_rom2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_rom2.tcl
