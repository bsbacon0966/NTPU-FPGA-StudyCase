...
#
# Script generated by Vivado on Thu Jun 05 10:11:41 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : image_rom2.sh
...
#
# Usage        : image_rom2.sh
#                image_rom2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                image_rom2.sh [-reset_run]
#                image_rom2.sh [-reset_log]
#                image_rom2.sh [-help]
#
...
export RDI_DATADIR="D:/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "image_rom2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./image_rom2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot image_rom2 xil_defaultlib.image_rom2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim image_rom2 -key {Behavioral:sim_1:Functional:image_rom2} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb image_rom2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./image_rom2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: image_rom2.sh [-help]\n\
Usage: image_rom2.sh [-step]\n\
Usage: image_rom2.sh [-lib_map_path]\n\
Usage: image_rom2.sh [-reset_run]\n\
Usage: image_rom2.sh [-reset_log]\n\
Usage: image_rom2.sh [-keep_index]\n\
Usage: image_rom2.sh [-noclean_files]\n\n\
