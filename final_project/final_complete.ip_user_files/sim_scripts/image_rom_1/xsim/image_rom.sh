...
#
# Script generated by Vivado on Wed Jun 04 20:18:38 +0800 2025
...
#
# Usage        : image_rom.sh
#                image_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                image_rom.sh [-reset_run]
#                image_rom.sh [-reset_log]
#                image_rom.sh [-help]
#
...
# script info
echo -e "image_rom.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./image_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot image_rom xil_defaultlib.image_rom xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb image_rom.wdb xsim.dir libdpi.so)
...
Usage: image_rom.sh [-step]\n\
Usage: image_rom.sh [-lib_map_path]\n\
Usage: image_rom.sh [-reset_run]\n\
Usage: image_rom.sh [-reset_log]\n\
Usage: image_rom.sh [-keep_index]\n\
